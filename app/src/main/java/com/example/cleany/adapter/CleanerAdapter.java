package com.example.cleany.adapter;
...
import com.example.cleany.R;
import com.example.cleany.addreview;
...
public class CleanerAdapter extends RecyclerView.Adapter<CleanerAdapter.cleanerAdapater>{
    ...
    @NonNull
    @Override
    public cleanerAdapater onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull cleanerAdapater holder, int position) {
